...
class PatientsData(models.Model):
    ...
    gender = models.CharField(max_length=100, choices=choices.GENDER_CHOICE, null=True, blank=True)
...
class TreatmentRecord(models.Model):
    ...
    history_of_chief_complaint = models.TextField(null=True, blank=True)
    blood_pressure = models.CharField(max_length=50, null=True, blank=True)
    blood_sugar = models.PositiveIntegerField(default=0,null=True, blank=True)
